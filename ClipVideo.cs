...
namespace Clip_CSL3
{
    class ClipAudio
    {
        ...
        //finds time into video to start and stop
        public void getStartStopTime()
        {
            Logger.Logger log = new Logger.Logger(this.cutLog, "TeamNumber", "subjectID_A", "subjectID_B", "subjectID_C", "MinDiffStart", "MinDiffStartTimeStamp", "StartTimeIntoVid", "MinDiffStop", "MinDiffStopTimeStamp", "StopTimeIntoVid");
        ...
        public void performClip()
        {
            ...
            {
                inAudio = "\"" + Constants.AUDIO_DIRECTORY_IN + this.teamNum + "\\" + this.teamNum + "-zoom_1.mp4\"";
                outAudio = "\"" + Constants.AUDIO_DIRECTORY_OUT + this.teamNum + "-zoom_1-clipped.avi\"";
                arguments = "-i " + inAudio + " -ss " + this.startTimeIntoAud.ToString(@"hh\:mm\:ss\.fff") + " -to " + this.stopTimeIntoAud.ToString(@"hh\:mm\:ss\.fff") + " -c:v libxvid -q:v 1 " + outAudio;
            }

            else
            {
                inAudio = "\"" + Constants.AUDIO_DIRECTORY_OUT + this.participant + "-Challenges-camera.avi\"";
                outAudio = "\"" + Constants.AUDIO_DIRECTORY_OUT + this.participant + "-Challenges-camera-clipped.avi\"";
